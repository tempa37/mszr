...
window.onload = function() {
	...
	initialData.rs485speed = document.getElementById('field4-speed').value;
	initialData.rs485stopbit = document.getElementById('field4-stopbit').value;
	initialData.rs485parity = document.getElementById('field4-parity').value;
		...
		const defaultStopBit = extractValue(document.getElementById('field21').value);
		...
		const defaultParity = extractValue(document.getElementById('field22').value);
...
function saveData() {
    ...
    if (!validateData(updatedData.ip, updatedData.port, updatedData.gateway)) {
		invaliddata();
        return; 
    }
